...
fn run(input: input::ResponseData) -> Result<output::FunctionRunResult> {
    ...
    if total_quantity < config.quantity {
        eprintln!("Total quantity of cart lines is less than the required quantity for volume discount.");
